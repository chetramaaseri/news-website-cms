                ...
                if (mysqli_num_rows($result1) > 0) {
                    while ($row1 = mysqli_fetch_assoc($result1)) {
                        if($row['category']==$row1['category_id']){ 
                            ?> <option selected value="<?php echo($row1['category_id']) ?>"><?php echo($row1['category_name']) ?></option> <?php
                        }else{
                            ?> <option value="<?php echo($row1['category_id']) ?>"><?php echo($row1['category_name']) ?></option> <?php
                        }
                    }
                }
                ?>
